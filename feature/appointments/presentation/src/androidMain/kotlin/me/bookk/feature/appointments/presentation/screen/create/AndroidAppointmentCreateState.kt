...
internal class AndroidAppointmentCreateState : AppointmentCreateState {
    ...
    override val clientPicker: PickerFieldState<SimplePickerPresentation<ClientSnapshot>> = AndroidPickerFieldState()
    override val servicePickers: ListState<PickerFieldState<SimplePickerPresentation<ServiceSnapshot>>> = AndroidListState()
