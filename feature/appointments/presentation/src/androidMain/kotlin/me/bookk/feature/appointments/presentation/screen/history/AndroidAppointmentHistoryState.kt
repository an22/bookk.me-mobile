...
internal class AndroidAppointmentHistoryState : AppointmentHistoryState {
    override val appBar: AppBarState = AndroidAppBarState()
    override val searchField: TextFieldState = AndroidTextFieldState()
    override val appointments: ListState<AppointmentHistoryItemState> = AndroidListState()
    ...
    override val navigation: NavigationState<AppointmentHistoryDestinations> = AndroidNavigationState()
}
